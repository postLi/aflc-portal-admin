...
export default {
  ...
  children: [
    ...
    // 物流公司、专线管理
    {
      path: '/carrier/logistics/group', icon: 'QQ', name: '我的网点', component: _import('carrier/logistics/index'), redirect: '/logistics/manageGroup', meta: { role: ['admin'], title: '我的网点', istab: true, noCache: false },
      children: [
        {
