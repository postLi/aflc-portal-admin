...
export default {
  ...
  children: [
    ...
    // 订单管理
    {
      ...
      children: [
        {
          path: '/carrier/order/manage/owner', icon: 'QQ', name: '我创建的订单', component: _import('carrier/order/manage/index'), meta: { role: ['admin'], title: '我创建的订单', noCache: false }
        },
        {
          path: '/carrier/order/manage/carrier', icon: 'QQ', name: '我承运的订单', component: _import('carrier/order/manage/index'), meta: { role: ['admin'], title: '我承运的订单', noCache: false }
        },
        {
          path: '/carrier/order/detail', icon: 'QQ', name: '订单详情', component: _import('carrier/order/detail/index'), meta: { role: ['admin'], title: '订单详情', noCache: false }
        },
        {
    ...
    // 我的收藏
    {
      path: '/carrier/collection', hidden: true, icon: 'QQ', name: '我的收藏', component: _import('carrier/collection/index'), redirect: '/carrier/collection/resource', meta: { role: ['admin'], title: '我的收藏', istab: true, noCache: false },
      children: [
        {
